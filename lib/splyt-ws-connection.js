...
module.exports = class SplytWSConnection extends CoEventEmitter {
  ...
  constructor(url, options = {}) {
    ...
    this.messageHandler.on('request', (method, data, socket) => this.call('request', method, data, socket));
    this.messageHandler.on('push', (method, data, socket) => this.call('push', method, data, socket));
  }
